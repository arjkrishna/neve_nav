#!/usr/bin/env python3
"""
diagnose_collapse5.py

Enhanced "collapse forensics" tool for stEVE / eve_rl SAC diagnostics.

Version 5 fixes (from logging framework analysis):
...
def write_report(
    ...
    md_path = out_dir / "collapse_report_v5.md"
    ...
    lines: List[str] = []
    lines.append("# Collapse Forensics Report (v5)\n")
...
def main():
    ap = argparse.ArgumentParser(description="Enhanced collapse forensics tool (v5)")
    ...
    # Console summary
    print("=" * 90)
    print("Collapse Forensics Summary (v5)")
    print("=" * 90)
